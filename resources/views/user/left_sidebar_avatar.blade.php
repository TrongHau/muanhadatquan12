...
<div class="main-r main-r1">
    <div class="boxsearch-right box1-right boxsearch-right box1-menu">
        ...
        <div class="detail_R detail_box_admin_L">
            <ul class="thongtintaikhoan">
                <li class="icon_huongdan_dangtin"><a href="http://muanhadatquan12.com/member/site/huongdandangtin">Hướng dẫn đăng tin</a></li>
                <li class="icon_huongdan_dangtin"><a href="http://muanhadatquan12.com/member/site/huongdannapgold">Hướng dẫn nạp Gold</a></li>
                <!-- <li class="icon_huongdan_dangtin"><a href="#">Hướng dẫn Up tin tự động</a></li> -->
            </ul>
        </div>
    </div></div>
